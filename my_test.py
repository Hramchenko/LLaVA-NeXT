...
pretrained = "/hdd_0/user/ML/LLM/llama3-llava-next-8b"
...
#f_name = "/hdd_0/user/tmp/llm_test/gpt-4o/001/we_artem_1.jpg"
f_name = "data/afhq/train/wild/flickr_wild_000002.jpg"
...
#question = DEFAULT_IMAGE_TOKEN + "\nDescribe the man's hair in a few words?"
#question = DEFAULT_IMAGE_TOKEN + "\nDescribe the man's hair"
#question = DEFAULT_IMAGE_TOKEN + "\nDescribe the man's hair in a few words"
...
# %%
tokenizer.tokenize('a big elephant')

# %%
prompt_question

# %%
tokenizer.batch_decode(cont, skip_special_tokens=False)
