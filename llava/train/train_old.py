...
def train(attn_implementation=None):
    ...
    if model_args.vision_tower is not None:
        if 'mpt' in model_args.model_name_or_path:
            ...
            print("xxxxxx", model_args.model_name_or_path,
                dict(cache_dir=training_args.cache_dir,
    ...
    print("My tokenizer")
    tokenizer = transformers.AutoTokenizer.from_pretrained(
        "/hdd_0/user/ML/LLM/llama3-llava-next-8b-tokenizer/",#model_args.model_name_or_path,
        #"/hdd_0/user/ML/LLM/Meta-Llama-3-8B-Instruct/",
        cache_dir=training_args.cache_dir,
        model_max_length=training_args.model_max_length,
        padding_side="right",
        use_fast=False,
